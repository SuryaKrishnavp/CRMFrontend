...
const BuyList = () => {
  ...
  try {
    ...
    const response = await axios.get("https://bussinesstoolcrm.up.railway.app/databank/salesmanager_buy_data/", {
      headers: {
    ...
    <StaffLayout>
      <div className={styles.container}>
        ...
        <div className={styles.headerContainer}>
          <h2 className={styles.title}>Buy Listings ({data.length})</h2>
