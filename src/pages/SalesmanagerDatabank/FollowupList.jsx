...
const FollowUpList = () => {
  ...
  const fetchFollowUps = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://bussinesstoolcrm.up.railway.app/followups/lead_wise_followup/${leadId}`,
        {
          headers: {
  ...
  const handleUpdateFollowup = async (id) => {
    ...
    try {
      ...
      await axios.put(
        `https://bussinesstoolcrm.up.railway.app/followups/edit_followup/${id}/`,
        {
      ...
      if (updatedData.status.trim()) {
        ...
        const statusURL = `https://bussinesstoolcrm.up.railway.app/followups/followup_status_entry/${id}/`;
        await axios[method](
          statusURL,
          {
  ...
  const handleDeleteFollowup = async (id) => {
    ...
    try {
      const accessToken = localStorage.getItem("access_token");
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/followups/cancel_followup/${id}/`, {
