...
const SalesMForrentList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get("https://bussinesstoolcrm.up.railway.app/databank/salesmanager_forrent_databank/", {
        headers: {
    ...
    <StaffLayout>
      <div className={styles.container}>
        ...
        <div className={styles.headerContainer}>
          <h2 className={styles.title}>For Rent Listings ({data.length})</h2>
...
export default SalesMForrentList;
