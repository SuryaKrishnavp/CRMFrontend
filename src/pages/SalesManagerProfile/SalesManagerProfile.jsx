    ...
    const fetchData = async () => {
      try {
        ...
        const [profileRes, summaryRes] = await Promise.all([
          axios.get("https://bussinesstoolcrm.up.railway.app/auth/salesmanager_details/", { headers }),
          axios.get("https://bussinesstoolcrm.up.railway.app/task/salesmanager_personal_workhistory/", { headers }),
        ]);
  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.profileCard}>
        ...
        <img
            src={profile.photo ? `https://bussinesstoolcrm.up.railway.app${profile.photo}` : ProfileImage}
