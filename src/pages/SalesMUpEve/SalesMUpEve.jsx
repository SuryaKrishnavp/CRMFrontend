...
const UpcomingEvents = () => {
  ...
  try {
    const response = await axios.get(
      "https://bussinesstoolcrm.up.railway.app/followups/Upcomming_salesmanager_event/",
      {
  ...
  const handleDelete = async (item) => {
    ...
    const url =
      item.type === "event"
        ? `https://bussinesstoolcrm.up.railway.app/task/salesmanager_event_delete/${item.id}/`
        : `https://bussinesstoolcrm.up.railway.app/followups/cancel_followup/${item.id}/`;
  ...
  const handleEditSubmit = async () => {
    ...
    const url =
      editItem.type === "event"
        ? `https://bussinesstoolcrm.up.railway.app/task/salesmanager_event_update/${editItem.id}/`
        : `https://bussinesstoolcrm.up.railway.app/followups/edit_followup/${editItem.id}/`;
  ...
  const handleStatusUpdate = async () => {
    ...
    const url =
      editItem.type === "event"
        ? `https://bussinesstoolcrm.up.railway.app/task/sm_event_status_entry/${editItem.id}/`
        : `https://bussinesstoolcrm.up.railway.app/followups/followup_status_entry/${editItem.id}/`;
