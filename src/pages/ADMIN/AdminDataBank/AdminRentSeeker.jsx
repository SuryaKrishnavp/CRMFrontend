...
const AdminRentseekerList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get("https://bussinesstoolcrm.up.railway.app/databank/rental_seeker/", {
        headers: {
...
export default AdminRentseekerList;
