  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        "https://bussinesstoolcrm.up.railway.app/leads/get_successfullyclosed_leads/",
        {
    ...
    <AdminLayout>
      <div className={styles.container}>
        <div className={styles.header}>
          <h2 className={styles.title}>Successfully Closed Leads ({leads.length})</h2>
          <button
...
export default AdminClosedLeads;
