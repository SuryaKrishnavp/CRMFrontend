...
const AdminDataSavedLeads = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      const res = await axios.get(
        "https://bussinesstoolcrm.up.railway.app/leads/get_datasaved_leads/",
  ...
  const fetchSalesManagers = async () => {
    ...
    try {
      const res = await axios.get(
        "https://bussinesstoolcrm.up.railway.app/auth/list_of_salesmangers/",
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const assignFollower = async () => {
    ...
    try {
      await axios.patch(
        `https://bussinesstoolcrm.up.railway.app/leads/add_follower/${selectedLeadId}/`,
  ...
  const handleViewData = (lead) => {
    ...
    axios
      .get(
        `https://bussinesstoolcrm.up.railway.app/databank/lead_into_db_admin/${lead.id}/`,
