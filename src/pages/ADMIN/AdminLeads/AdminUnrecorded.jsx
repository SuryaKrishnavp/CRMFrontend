...
const AdminUnrecordedLeads = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      const res = await axios.get("https://bussinesstoolcrm.up.railway.app/leads/unrecorded_leads_admin/", {
  ...
  const handleDeleteLead = async (leadId) => {
    ...
    try {
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/leads/delete_lead/${leadId}/`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchLeads();
    } catch (err) {
