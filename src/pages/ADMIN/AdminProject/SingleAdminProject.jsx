...
const AdminProjectDetails = () => {
  ...
  const fetchProject = async () => {
    ...
    try {
      const response = await axios.get(
        `https://bussinesstoolcrm.up.railway.app/project/retrive_project/${id}/`,
        {
  ...
  const handleProjectUpdate = async () => {
    ...
    try {
      await axios.put(
        `https://bussinesstoolcrm.up.railway.app/project/edit_project/${id}/`,
        editForm,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleViewData = (lead) => {
    ...
    axios
      .get(`https://bussinesstoolcrm.up.railway.app/databank/lead_into_db_admin/${lead.lead}/`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
  ...
  const handleRemoveDatabank = async (dataBankId) => {
    ...
    try {
      await axios.delete(
        `https://bussinesstoolcrm.up.railway.app/project/remove_data_banks/${id}/`,
        {
          headers: { Authorization: `Bearer ${token}` },
  ...
  const handleRemoveProject = async () => {
    ...
    try {
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/project/remove_project/${id}/`, {
        headers: { Authorization: `Bearer ${token}` },
      });
