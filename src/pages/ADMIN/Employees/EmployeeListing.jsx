...
const AdminEmployeeListing = () => {
  ...
  const fetchEmployees = async () => {
    ...
    try {
      const response = await axios.get("https://bussinesstoolcrm.up.railway.app/auth/list_employees/", {
        headers: {
  ...
  const handleDelete = async (glmId) => {
    ...
    try {
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/auth/delete_glm/${glmId}/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleUpdateGLM = async () => {
    const token = localStorage.getItem("access_token");
    try {
      await axios.put(`https://bussinesstoolcrm.up.railway.app/auth/update_glm/${selectedEmployee.id}/`, editedData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
              ...
              <div key={index} className={styles.leadCard}>
                <div className={styles.leadInfo}>
                  <div className={styles.infoBlock}>
                    <img
                      src={emp.photo ? `https://bussinesstoolcrm.up.railway.app${emp.photo}` : ProfileImage}
                      alt={emp.username}
