...
const AdminSalesManagerProfile = () => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      const res = await axios.get(`https://bussinesstoolcrm.up.railway.app/task/admin_salesmanager_workhistory/${id}/`, {
  ...
  const fetchProjectData = async () => {
    ...
    try {
      const res = await axios.get(`https://bussinesstoolcrm.up.railway.app/project/salesmanager_project_admin/${id}/`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://bussinesstoolcrm.up.railway.app/auth/update_salesmanager/${id}/`, formData, {
        headers: {
      ...
      if (showPasswordFields) {
        ...
        await axios.patch(
          `https://bussinesstoolcrm.up.railway.app/auth/update_salesmanager_password/${id}/`,
  ...
  const handleDelete = async () => {
    ...
    const token = localStorage.getItem("access_token");
    try {
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/auth/delete_salesmanager/${id}/`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <AdminLayout>
      <div className={styles.container}>
        ...
        <img
            src={photo ? `https://bussinesstoolcrm.up.railway.app${correctedPhoto}` : ProfileImage}
            alt={name}
                    ...
                    <img
                      src={
                        editData.photo
                          ...
                          : (photo ? `https://bussinesstoolcrm.up.railway.app${photo}` : ProfileImage)
                      }
                      alt="Preview"
