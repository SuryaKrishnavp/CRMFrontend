...
const AdminDashboard = () => {
  ...
  const fetchCrmPerformance = async () => {
    try {
      const res = await axios.get("https://bussinesstoolcrm.up.railway.app/leads/admin_crm_performance_graph/", {
  ...
  const fetchLeadGraph = async () => {
    try {
      const res = await axios.get("https://bussinesstoolcrm.up.railway.app/leads/admin_crm_graph_leads/", {
        headers: { Authorization: `Bearer ${accessToken}` },
      });
  ...
  const fetchUpcomingEvents = async () => {
    try {
      const res = await axios.get("https://bussinesstoolcrm.up.railway.app/task/todays_upcoming_events/", {
        headers: { Authorization: `Bearer ${accessToken}` },
      });
      setEvents(res.data || []);
    } catch (error) {
  ...
  const fetchReminders = async () => {
    ...
    try {
      const res = await axios.get("https://bussinesstoolcrm.up.railway.app/task/get_event_reminder/", {
        headers: { Authorization: `Bearer ${accessToken}` },
      });
