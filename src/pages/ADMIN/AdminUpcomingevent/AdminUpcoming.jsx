...
const AdminUpcomingEvents = () => {
  ...
  const fetchEvents = async () => {
    ...
    try {
      const response = await axios.get("https://bussinesstoolcrm.up.railway.app/task/list_events/", {
  ...
  const handleDeleteEvent = async (eventId) => {
    ...
    try {
      const accessToken = localStorage.getItem("access_token");
      await axios.delete(`https://bussinesstoolcrm.up.railway.app/task/event_delete/${eventId}/`, {
        headers: { Authorization: `Bearer ${accessToken}` },
      });
  ...
  const handleUpdateEvent = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://bussinesstoolcrm.up.railway.app/task/event_update/${editEventData.id}/`,
        payload,
        {
          headers: {
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      ...
      await axios[method](
        `https://bussinesstoolcrm.up.railway.app/task/admin_event_status_entry/${editEventData.id}/`,
        statusPayload,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
