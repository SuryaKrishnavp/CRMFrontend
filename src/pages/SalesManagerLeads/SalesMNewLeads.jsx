...
const LeadsList = () => {
  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "https://bussinesstoolcrm.up.railway.app/leads/get_new_leads/",
        {
          headers: {
  ...
  const handleAddLead = () => {
    navigate("/addlead_salesman"); // ✅ Redirect to Add Lead Page
  };
  ...
  const handleFollowUp = async (leadId) => {
    ...
    try {
      await axios.post(
        `https://bussinesstoolcrm.up.railway.app/leads/takelead/${leadId}/`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
