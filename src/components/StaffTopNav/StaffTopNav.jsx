...
const StaffTopNav = () => {
  ...
  useEffect(() => {
    ...
    const pollFollowupReminders = () => {
      ...
      axios
        .get("https://bussinesstoolcrm.up.railway.app/followups/followup-reminders/", {
  ...
  try {
    const response = await axios.get(
      `https://bussinesstoolcrm.up.railway.app/databank/search_by_salesmanager/?q=${encodeURIComponent(finalQuery)}`,
      { headers: { Authorization: `Bearer ${token}` } }
    );
  ...
  debounceRef.current = setTimeout(async () => {
    ...
    try {
      const res = await axios.get(
        `https://bussinesstoolcrm.up.railway.app/databank/salesMSearchAutoComplete/?q=${encodeURIComponent(value)}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
